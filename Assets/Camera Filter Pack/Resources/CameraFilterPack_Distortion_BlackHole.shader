...
float light = clamp(0.005*distance(center.xy, (i.texcoord.xy * _ScreenResolution.xy)) - _Distortion, 0.0, 1.0);
float light2 = 1-clamp(0.002*distance(center.xy, (i.texcoord.xy * _ScreenResolution.xy)) - _Distortion, 0.0, 1.0);
light= light-light2;
